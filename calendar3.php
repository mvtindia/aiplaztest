...
<div class="container-fluid"><!--container-fluid start-->
    <div class="row">
        ...
        <div class="container"  >
            <button id="mvdtb">&#8592;</button><button id="mvdtf">&#8594;</button><a href="calendar.php?<?php echo $_SERVER['QUERY_STRING'] ?>">Weekly</a>
...
$(document).ready(function() {
    ...
    $( "#mvdtf" ).click(function() {
        ...
        //dae = new Date( i);
        //dae = new Date(dae.getFullYear() + "-" + ("0" + (dae.getMonth() + 2)).slice(-2) + "-" + ("0" + dae.getDate()).slice(-2));
        //dp.startDate = dae.getFullYear() + "-" + ("0" + (dae.getMonth() + 2)).slice(-2) + "-" + ("0" + dae.getDate()).slice(-2);
