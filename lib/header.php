...
if(!isset($_SESSION['u_id']))
{
  if ($fbUser) {
    ...
    $query = mysqli_query($connect, "INSERT INTO `users` SET `fuid` = '9999999', `fname` = '".$fbUserProfile['first_name']."', `lname` = '".$fbUserProfile['last_name']."', `email` = '".$fbUserProfile['email']."', `pwd` = 'password'");         
    error_log($query);
