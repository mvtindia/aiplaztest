...
//if(isset($_REQUEST['searching'])) { 
 ...
 //$daterange = $_REQUEST['daterange'];
  ...
  $choutvarpl = date('Y-m-d', strtotime($choutvar . "+1 days"));
  error_log($chinvar);
  error_log($chinvarpl);
