                        ...
                        <div class="panel-body">
                            <form  id="" action="upproduct.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                   ...
                                   <option value="" hidden>Select Info Category</option>
                               ...
                               <div class="form-group last">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                    <input type="text" name="product" class="form-control" value="" required="required">
                                </div>
                            </div>
							 ...
							 <div class="form-group last">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                <textarea class="form-control ckeditor" name="editor1" rows="6" placeholder="Product Description" required>
                                </textarea>
                                </div>
                            </div>
                                 <div class="form-group last">
                                     <div class="col-md-5" class="iconic-input">
                                         <button class="btn btn-info" type="submit" name="adddata" >Add Data</button>
                                    </div>
                                 </div>
                            </form>
                        </div>
