 ...
 <?php include("header.php");?>
        ...
        <div class="row">
           ...
           if(isset($_REQUEST['uphome1']))
          {
            ...
            $query=mysqli_query($connect,"UPDATE `pages` SET `page_content`='".$content."' where page_title='Work'");
            if($query)
            {
...
width: 300px !important;
  ...
  <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group last">
                                <label class="control-label col-md-3">How it Works</label>
                             ...
                             <input type="hidden" name="cid" class="form-control" value="<?php echo $row["page_id"];?>" required="required">
                                 ...
                                 <div class="form-group last">
                                     <div class="col-md-5" class="iconic-input">
                                         <button class="btn btn-info" type="submit" name="uphome1">Edit Work</button>
                                    </div>
                                 </div>
                            </form>
        </div>
