                        ...
                        <div class="panel-body">
                            <form  id="" action="upproduct.php" method="post" class="form-horizontal" enctype="multipart/form-data">
							 ...
							 <div class="form-group last">
                                ...
                                <textarea class="form-control ckeditor" name="address" rows="4" placeholder="Address" required="required">
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                    <input type="email" name="cemail" placeholder="Email Address" class="form-control" value="<?php echo $row["email"]; ?>" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                    <input type="tel" name="c1" placeholder="Contact No. (1)" class="form-control" value="<?php echo $row["contact1"]; ?>" required="required">
                                </div>
                            </div>
                             <div class="form-group last">
                                <label class="control-label col-md-3">Contact No. (2)</label>
                                <div class="col-md-5" class="iconic-input">
                                    <input type="tel" name="c2" class="form-control" placeholder="Contact No. (2)" value="<?php echo $row["contact2"]; ?>" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-5" class="iconic-input">
                                <textarea class="form-control ckeditor" name="map" rows="6" placeholder="MAp Iframe Source" required="required"><?php echo $row["map"]; ?></textarea>
                                </div>
                            </div>

                                 <div class="form-group last">
                                     <div class="col-md-5" class="iconic-input">
                                         <button class="btn btn-info" type="submit" name="upcdata" >Update Contact Info</button>
                                    </div>
                                 </div>
                            </form>
                        </div>
